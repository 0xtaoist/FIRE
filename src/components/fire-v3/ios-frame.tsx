...
/* iOS 26 device frame — ported from the Claude Design handoff (ios-frame.jsx).
   Slim cut: device shell + dynamic island + status bar + home indicator, dark.
   The scrollworld phone uses width 402 × height 874 with no nav bar/keyboard. */
